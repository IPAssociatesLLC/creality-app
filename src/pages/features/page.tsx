    ...
    <div className="min-h-screen bg-background-50">
      ...
      <section className="pt-28 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground-950 leading-tight mb-5">
            Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-500 to-secondary-500">build incredible apps.</span>
          </h1>
