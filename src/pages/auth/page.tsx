    ...
    <div className="min-h-screen bg-background-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-background-100 border border-background-300/60 rounded-2xl p-6">
          ...
          <div className="text-center mb-5"><h1 className="text-lg font-semibold text-foreground-950 mb-1">{tab === "login" ? "Welcome back" : "Join CreAIlity"}</h1><p className="text-xs text-foreground-500">{tab === "login" ? "Sign in to access your projects." : "Create an account to start building."}</p></div>
        ...
        <p className="text-center text-[10px] text-foreground-600 mt-6">Your projects are stored securely in your account.</p>
      </div>
    </div>
  );
}